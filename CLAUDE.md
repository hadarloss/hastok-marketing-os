...
| בניית תוכנית רב-סוכנית (2+ משימות) | מנהל הצוות בונה (`proposePlan`) ו**מריץ מיד** באותו stream | אף פעם — אין יותר מסך אישור תוכנית |
| מעבר בין משימה למשימה בתוך תוכנית | הקלאסיפייר (`classifyNextStep`), אוטומטית | לא |
