 ...
 * Runs on GPT-5.6 Terra via OpenAI regardless of which provider the replying agent itself uses —
 * this is a standalone classification call, not a continuation of the specialist's own turn.
 */
